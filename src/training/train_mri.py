...
from src.models.convnext_mri import create_mri_model, get_transforms
...
def main():
    ...
    ap.add_argument("--model-name", default="convnext_base")
    ...
    model = create_mri_model(num_classes=num_classes, model_name=args.model_name, pretrained=args.pretrained)
    model.to(device)
